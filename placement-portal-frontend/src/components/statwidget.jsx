...
/**
 * Reusable component to display a key statistic/metric.
 * 
 * @param {string} title - The title of the statistic (e.g., "Active Jobs").
 * @param {string|number} value - The main numerical/statistical value.
 * @param {string} trend - Description of trend (e.g., "+3 since last month").
 * @param {'up'|'down'|'neutral'} trendType - Determines color/icon for trend.
 * @param {object} IconComponent - Optional MUI icon to display (default: AttachMoneyIcon).
 */
const StatWidget = ({
  title,
  value,
  ...
  // Determine color/icon for trend direction
